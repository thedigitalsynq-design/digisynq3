...
import { ChevronRight, ArrowRight, RotateCcw, Layers, Sparkles, CheckCircle2 } from 'lucide-react';
import { PROBLEM_CATEGORIES, type ProblemCategory } from '../data/problem_categories';
...
export function ProblemEngine({ compact = false }: ProblemEngineProps) {
  ...
  const handleCategorySelect = (cat: ProblemCategory, index: number) => {
    playNodeBlip(index);
